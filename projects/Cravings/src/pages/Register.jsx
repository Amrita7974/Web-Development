...
import foodTable from "../images/foodTable.png";
...
function Register() {
  return (
    <div className="relative w-full h-auto md:h-[90vh] flex flex-col md:block overflow-hidden bg-[#fff8f1] font-sans">
      ...
      <div className="<div className=w-[90%] max-w-[450px] mx-auto my-6 md:my-0 p-4 md:p-6 bg-white rounded-lg shadow-lg md:absolute md:top-[50%] md:right-[8%] md:-translate-y-1/2">
